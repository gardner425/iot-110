...
#DEFAULT Route
# curl http://iot405b.local:5000/
@app.route("/")
def hello():
    return "Hello API Server : Default Request from (hostname) : " + hostname + "!\n"

#GET REQUEST
# curl http://iot405b.local:5000/getHello
@app.route('/getHello')
def getRequestHello():
...
# echo 'mykey={"name":"Gene Cernan","age":"82"}' | curl -d @- http://iot405b.local:5000/createHello
...
##  it externally visible with 0.0.0.0:5000 (default), or iot405b.local:5000 
